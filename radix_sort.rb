...
# Output the array and find the maximum number of digits in the arr
puts "Input Array: "
max_length = 0
for i in (0..NUM_STUDENTS - 1)
...
# Add 0 padding on the max length, simplifying the sort algorithm
for i in (0..NUM_STUDENTS - 1)
  arr[i] = arr[i].rjust(max_length, "0")
end

# Now lets use a radix sort. Go through each digit and
